 ...
 */
public class RichTextDocumentElementV2 extends DocumentElement implements CharSequence, GetChars, Spannable, Appendable {

    public static final Creator<RichTextDocumentElementV2> CREATOR = DynamicParcelableCreator.getInstance(RichTextDocumentElementV2.class);

    /**
     * Create a new SpannableStringBuilder with empty contents
     */
    public RichTextDocumentElementV2() {
        this("");
    }
     ...
     */
    public RichTextDocumentElementV2(CharSequence text) {
     ...
     */
    public RichTextDocumentElementV2(CharSequence text, int start, int end) {
    ...
    public RichTextDocumentElementV2 insert(int where, CharSequence tb, int start, int end) {
        return replace(where, where, tb, start, end);
    }

    // Documentation from interface
    public RichTextDocumentElementV2 insert(int where, CharSequence tb) {
        return replace(where, where, tb, 0, tb.length());
    }

    // Documentation from interface
    public RichTextDocumentElementV2 delete(int start, int end) {
        RichTextDocumentElementV2 ret = replace(start, end, "", 0, 0);
    ...
    // Documentation from interface
    public RichTextDocumentElementV2 append(CharSequence text) {
        int length = length();
        return replace(length, length, text, 0, text.length());
    }

    // Documentation from interface
    public RichTextDocumentElementV2 append(CharSequence text, int start, int end) {
        int length = length();
        return replace(length, length, text, start, end);
    }

    // Documentation from interface
    public RichTextDocumentElementV2 append(char text) {
    ...
    // Documentation from interface
    public RichTextDocumentElementV2 replace(int start, int end, CharSequence tb) {
        return replace(start, end, tb, 0, tb.length());
    }

    // Documentation from interface
    public RichTextDocumentElementV2 replace(final int start, final int end,
                                          CharSequence tb, int tbstart, int tbend) {
